...
To find out which properties are theme-aware, see the [Style Props](https://chakra-ui.com/docs/features/style-props).
...
In case you need to set a CSS property that is not listed in the [Style Props](/docs/features/style-props) list, you can use the `sx` prop and pass it whatever CSS property you desire.
...
> For the following example you could also use the [`_groupHover` shorthand prop](/docs/features/style-props#pseudo).
