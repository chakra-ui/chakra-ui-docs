...
[**Features > Color Mode # Add ColorModeScript**](/docs/styled-system/features/color-mode#add-colormodescript).
...
- Deprecated the `RadioButton` component. Use the `useRadio` hook to create
  ...
  [creating custom radio buttons](/docs/components/form/radio#custom-radio-buttons).
