...
If you're using the latest version of `framer motion`, which is `>= v 3.10.0`. In this version, `framer-motion` automatically filters out motion-related props forwarded to the provided component. [Reference](https://www.framer.com/api/motion/component/#custom-components)
