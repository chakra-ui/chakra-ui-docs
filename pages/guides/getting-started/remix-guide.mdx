...
> This guide is still work in progress! Feel free to contribute if you have built something with Remix and Chakra UI 😃

#### 1. Installation

Inside your `Remix` project root directory, install Chakra UI by running:

```bash
npm i @chakra-ui/react @emotion/react@^11 @emotion/styled@^11 framer-motion@^4
```

> As of now yarn is not officially supported in Remix projects
