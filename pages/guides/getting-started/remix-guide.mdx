...
> built something with Remix and Chakra UI 😃

#### 1. Installation

Inside your `Remix` project root directory, install Chakra UI by
...
> 🚨 As of now yarn is not officially supported in Remix projects, use with care!
