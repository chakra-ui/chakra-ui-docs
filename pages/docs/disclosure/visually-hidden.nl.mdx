...
description: VisuallyHidden is a common technique used in web accessibility to hide content from the visual client ---
---
...
<ComponentLinks github={{ package: "visually-hidden" }} npm={{ "@chakra-ui>
