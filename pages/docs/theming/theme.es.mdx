...
<ComponentLinks github={{ package: "theme" }} npm={{ "@chakra-ui>
...
We recommend adding a palette that ranges from `50` to `900`. Tools like [Themera](https://themera.vercel.app/), [Smart Swatch](https://smart-swatch.netlify.app/), [Coolors](https://coolors.co/app) or [Palx](https://palx.jxnblk.com) are available to generate these palettes.
...
Chakra provides a sensible [default theme](https://github.com/chakra-ui/chakra-ui/tree/main/packages/theme) inspired by Tailwind CSS, but you can customize it to fit your design.
...
We recommend trying to solve stacking issues without `z-index`. You can read our recommendations and learn more about [stacking contexts and z-index here](/guides/z-index).
