...
```jsx live=false
// The type can be found in @chakra-ui/theme, you can also use the more specific
// type for a single part component: ComponentSingleStyleConfig
...
```jsx live=false
// The type can be found in @chakra-ui/theme, you can also use the more specific
// type for a multipart component: ComponentMultiStyleConfig
