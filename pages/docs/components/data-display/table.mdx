...
```jsx
// The below table is in a constrained parent container to show the hidden overflow from `TableContainer`
<Box w='260px' mx='auto' p={6} border='2px solid' borderColor='blue.700'>
  <TableContainer>
    <Table>
      <Thead>
        <Tr>
