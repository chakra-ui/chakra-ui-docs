...
<ComponentLinks theme={{ componentName: "slider" }} github={{ package: npm ={{ "@chakra-ui>
...
The `RangeSlider` component wraps all its children in the [Box](/docs/layout/box) component, so you can pass all `Box` props to change its style.

<PropsTable of="RangeSlider" />

### RangeSliderThumb Props

`RangeSliderThumb` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.

### RangeSliderFilledTrack Props

`RangeSliderFilledTrack` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.

### RangeSliderTrack Props

`RangeSliderTrack` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.
