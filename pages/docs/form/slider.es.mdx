...
The `Slider` component wraps all its children in the [Box](/docs/layout/box) component, so you can pass all `Box` props to change its style.

<PropsTable of="Slider" />

### SliderThumb Props

`SliderThumb` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.

### SliderFilledTrack Props

`SliderFilledTrack` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.

### SliderTrack Props

`SliderTrack` composes [Box](/docs/layout/box) so you can pass all `Box` props to change its style.
