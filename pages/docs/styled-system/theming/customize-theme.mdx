...
> **About `mode`**
> `mode(LIGHT_COLOR, DARK_COLOR)` is a function that takes two arguments, a light mode color value, and a dark mode color value, to make it easy to switch between light/dark mode.
> You can inspect the function here: https://github.com/chakra-ui/chakra-ui/blob/main/packages/theme-tools/src/component.ts#L81
