...
[Style Props](https://chakra-ui.com/docs/api/features/style-props).
...
[Style Props](/docs/api/features/style-props) list, you can use the `sx` prop and
...
> [`_groupHover` shorthand prop](/docs/api/features/style-props#pseudo).
