...
See [this guide](/docs/api/theming/customize-theme#scaling-out-your-project) for
...
> [theme typings](/docs/api/theming/advanced#theme-typings) section for details.
...
[follow this guide](/docs/api/theming/customize-theme#scaling-out-your-project).
...
or, for a [theme package](/docs/api/theming/advanced#distributing-a-theme-package):
