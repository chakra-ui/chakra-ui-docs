...
> [Learn more](/docs/api/theming/component-style).
...
> [multipart components](/docs/api/theming/component-style#styling-multipart-components).
...
[In the next section](/docs/api/theming/component-style), we'll show some examples
