...
description: Containers are the most basic layout element in Chakra. It is used to constrain the maximum of the content it wraps. ---
---
...
<ComponentLinks theme={{ componentName: "container" }} github={{ package: "layout" npm  ={{ "@chakra-ui>
