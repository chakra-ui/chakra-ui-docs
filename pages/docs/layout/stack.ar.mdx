...
Stack is a layout component that makes it easy to stack elements together and apply a space between them. It uses a modified version of the [CSS lobotomized owl selector](https://alistapart.com/article/axiomatic-css-and-lobotomized-owls/) to add spacing between its children.

<ComponentLinks github={{ package: "layout" }} npm={{ "@chakra-ui>
