...
<ComponentLinks theme={{ componentName: "tooltip" }} github={{ package: npm ={{ "@chakra-ui>
...
> Note 🚨: If you're wrapping an icon from `react-icons`, you need to also wrap the icon in a `span` element as [`react-icons` icons do not use `forwardRef`](https://github.com/react-icons/react-icons/issues/336).
