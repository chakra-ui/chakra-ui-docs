...
description: Chakra exports four components `Fade`, `ScaleFade`, `Slide`, and `SlideFade` to provide simple transitions. ---
---

Chakra exports four components `Fade`, `ScaleFade`, `Slide`, and `SlideFade` to provide simple transitions.

<ComponentLinks theme={{ componentName: "transition" }} github={{ package: npm ={{ "@chakra-ui>
...
The transition components extends the [framer-motion](https://www.framer.com/api/motion/component/).
...
<PropsTable of="ScaleFade" only={["initialScale", "reverse", "unmountOnExit", "in"]} />
...
<PropsTable of="SlideFade" only={["offsetX", "offsetY", "reverse", "unmountOnExit", "in"]} />

### Collapse Props

<PropsTable of="Collapse" only={[ "animateOpacity", "unmountOnExit", "in", "startingHeight", "endingHeight", ]} />
