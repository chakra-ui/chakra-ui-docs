...
The Ant Design React library is an implementation of the [ant.design](https://ant.design/) design language. This means the components follow existing design rules and values, only allowing customizability to certain variables to a limited extent. Chakra is not tied down by any design systems and offers more freedom with customizing the components to implement your own design.
...
**— Vynlar** [(View Quote)](https://github.com/chakra-ui/chakra-ui/issues/1421#issuecomment-664423035)
...
**— ChasinHues** [(View Quote)](https://github.com/chakra-ui/chakra-ui/issues/1421#issuecomment-692369895)
