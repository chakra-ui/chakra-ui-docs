...
<ComponentLinks theme={{ componentName: "input" }} github={{ package: npm ={{ "@chakra-ui>
...
The `Input` component composes [Box](/docs/layout/box) so you can pass all `Box` props, and `React.InputHTMLAttributes`.
