...
<ComponentLinks theme={{ componentName: "breadcrumb" }} github={{ package: npm ={{ "@chakra-ui>
...
Breadcrumb composes [Box](/docs/layout/box) so you can pass all `Box` props to change the style of the breadcrumbs. Let's say we need to reduce the `fontSize` of the breadcrumbs.
...
The BreadcrumbLink composes the [Link](/link) component so you can use all Link props.

<PropsTable of="BreadcrumbLink" />

### BreadcrumbSeparator Props

The BreadcrumbSeparator composes the [Box](/docs/layout/box) component so you can use all Box props.
