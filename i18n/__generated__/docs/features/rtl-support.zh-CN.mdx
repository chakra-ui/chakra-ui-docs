...
title: RTL Support
version: 1.1+
description: Chakra UI provides built-in support right-to-left (RTL) languages like arabic and hebrew, out of the box. ---
---
...
Here's a list of the RTL-aware style props you can use alongside other [CSS logical properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties):
...
- Blog Post - [Setup an i18n routing with Nextjs and Chakra UI](https://dev.to/ugbechike/setup-an-internationalization-i18n-routing-web-app-with-nextjs-and-chakra-ui-39f1)
