...
<ComponentLinks theme={{ componentName: "select" }} github={{ package: npm ={{ "@chakra-ui>
...
The Select component composes [Box](/docs/layout/box) so you can pass all `Box` props, and native `Select` props in addition to these:
