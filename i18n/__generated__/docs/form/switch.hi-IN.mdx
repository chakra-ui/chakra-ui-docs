...
The `Switch` component is used as an alternative for the [Checkbox](/docs/form/checkbox) component. You can switch between enabled or disabled states.

<ComponentLinks theme={{ componentName: "switch" }} github={{ package: npm ={{ "@chakra-ui>
