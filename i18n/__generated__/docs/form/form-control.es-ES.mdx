...
It follows the [WAI specifications](https://www.w3.org/WAI/tutorials/forms/) for forms.

<ComponentLinks theme={{ componentName: "form" }} github={{ package: "form-control" npm  ={{ "@chakra-ui>
...
Form Libraries like [Formik](https://jaredpalmer.com/formik/) make it soooo easy to manage form state and validation. I 💖 Formik
