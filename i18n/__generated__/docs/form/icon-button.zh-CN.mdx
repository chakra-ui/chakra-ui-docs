...
<ComponentLinks github={{ package: "button" }} npm={{ "@chakra-ui>
...
You can also use icons from popular libraries like [react-icons](https://react-icons.github.io/react-icons/) and just pass it into the button.
