...
<ComponentLinks theme={{ componentName: "list" }} github={{ package: "layout" npm  ={{ "@chakra-ui>
...
`ListItem` composes [Box](/docs/layout/box) so you can pass all style and pseudo style props.
