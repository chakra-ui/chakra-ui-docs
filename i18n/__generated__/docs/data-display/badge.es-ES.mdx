...
<ComponentLinks theme={{ componentName: "badge" }} github={{ package: "layout" npm  ={{ "@chakra-ui>
...
Pass the `colorScheme` prop to customize the color of the Badge. `colorScheme` can be any **color key** that exists in `theme.colors`. [Learn more about theming](/docs/theming/theme).
