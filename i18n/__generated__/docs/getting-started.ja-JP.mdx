...
Add the [@chakra-ui/gatsby-plugin](https://www.gatsbyjs.com/plugins/@chakra-ui/gatsby-plugin/). It does everything automatically for you!
...
If you're adding Chakra UI to a `create-react-app` project, this means you'll need to manually upgrade `typescript` to `^4.1.0`.
