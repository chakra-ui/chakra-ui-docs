...
description: A React component that helps you build accessible tabs, by providing keyboard interactions and ARIA attributes described in the WAI-ARIA Tab Panel Design Pattern. ---
---

An accessible tabs component that provides keyboard interactions and ARIA attributes described in the [WAI-ARIA Tabs Design Pattern](https://www.w3.org/TR/wai-aria-practices-1.1/#tabpanel).

<ComponentLinks theme={{ componentName: "tabs" }} github={{ package: npm ={{ "@chakra-ui>
...
<PropsTable of="Tabs" omit={["isTruncated", "layerStyle", "noOfLines", "textStyle", "styleConfig"]} />
