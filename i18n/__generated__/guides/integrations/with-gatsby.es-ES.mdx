...
Chakra UI is a great UI library to get your [Gatsby](https://www.gatsbyjs.com/) website up and running fast. The setup is slightly different than other projects, however the API usage seen in the rest of the docs is the same!
...
To use a custom theme, you can [shadow](https://www.gatsbyjs.com/docs/how-to/plugins-and-themes/shadowing/) this plugin’s `theme.js` file with your own theme:
