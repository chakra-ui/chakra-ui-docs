...
Amazingly, the feedback received from this poll showed that 92% of 79 voters
were super ready! Receiving this incredible stat was only the first step and by
far the easiest one. We also had to clarify the goal of this Hackathon and weave
each part of the planning into this goal.
...
## Feedback; a secret weapon for improvement
...
Can't wait for the next Hackathon! Till then, keep calm and use Chakra UI.
