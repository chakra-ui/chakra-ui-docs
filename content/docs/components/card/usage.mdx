...
```js
import { Card, CardHeader, Flex, Avatar, Box, Heading, Text, IconButton, BsThreeDotsVertical, CardBody, Image, CardFooter, Button, BiLike, BiChat, BiShare  } from '@chakra-ui/react'
```
...
## Variants
```js
import { Card, CardHeader, Heading, CardBody, Text, Stack } from '@chakra-ui/react'
```
