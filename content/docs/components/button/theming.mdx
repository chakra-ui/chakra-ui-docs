...
- `defineStyleConfig`: a function to define the style configuration for a
  component.
...
Let's say we want to change the default size, variant or color scheme of every
button in our app. Here's how we can do that:
