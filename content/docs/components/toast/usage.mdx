...
Display a toast asynchronously based on a ``Promise`` for ``loading``,  ``success``, and ``error`` states:
...
/* Will display the loading toast until the promise is either resolved or 
rejected. */
toast.promise(examplePromise, {
	success: {title: "Promise has resolved", description: ...},
	error: {title: "Promise has been rejected", description: ...},
	loading: {title: "Promise is pending", description: ...}
});
```
