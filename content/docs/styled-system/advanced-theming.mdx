...
export default function App() {
  ...
  /**
   * In a real context, the provider is still in index.tsx
   * and the `customTheme` is exported.
   */
  return (
...
> [theme typings](/docs/styled-system/advanced#theme-typings) section for
> details.
