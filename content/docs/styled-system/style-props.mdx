...
// top left and top right radius will be `theme.radius.md` => 4px
...
| `borderTopStartRadius`    | `border-top-left-radius` in LTR,<br/> `border-top-right-radius` in RTL       | `radius`     |
| `borderTopRightRadius`    | `border-top-right-radius`                                                    | `radius`     |
| `borderTopEndRadius`      | `border-top-right-radius` in LTR,<br/> `border-top-left-radius` in RTL       | `radius`     |
| `borderBottomRightRadius` | `border-bottom-right-radius`                                                 | `radius`     |
| `borderBottomEndRadius`   | `border-bottom-right-radius` in LTR,<br/> `border-bottom-left-radius` in RTL | `radius`     |
| `borderBottomLeftRadius`  | `border-bottom-left-radius`                                                  | `radius`     |
| `borderBottomStartRadius` | `border-bottom-left-radius` in LTR,<br/> `border-bottom-left-radius` in RTL  | `radius`     |
