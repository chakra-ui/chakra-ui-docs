async function redirect() {
  return [
    ...
    {
      source: '/docs/styled-system/utility-hooks/use-boolean',
      destination: '/docs/hooks/use-boolean',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-breakpoint-value',
      destination: '/docs/hooks/use-breakpoint-value',
      permanent: true,
    },
    {
      source: '/docs/styled-system/component-hooks/use-checkbox',
      destination: '/docs/hooks/use-checkbox',
      permanent: true,
    },
    {
      source: '/docs/styled-system/component-hooks/use-checkbox-group',
      destination: '/docs/hooks/use-checkbox-group',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-clipboard',
      destination: '/docs/hooks/use-clipboard',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-const',
      destination: '/docs/hooks/use-const',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-controllable',
      destination: '/docs/hooks/use-controllable',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-disclosure',
      destination: '/docs/hooks/use-disclosure',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-media-query',
      destination: '/docs/hooks/use-media-query',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-merge-refs',
      destination: '/docs/hooks/use-merge-refs',
      permanent: true,
    },
    {
    ...
    {
      source: '/docs/styled-system/utility-hooks/use-prefers-reduced-motion',
      destination: '/docs/hooks/use-prefers-reduced-motion',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-theme',
      destination: '/docs/hooks/use-theme',
      permanent: true,
    },
    {
      source: '/docs/styled-system/utility-hooks/use-token',
