export const MenuIllustration = () => (
  ...
  >
    ...
    <path
      d='M53 59C53 55.6863 55.6863 53 59 53H159C162.314 53 165 55.6863 165 59V92C165 95.3137 162.314 98 159 98H59C55.6863 98 53 95.3137 53 92V59Z'
      fill='white'
    />
    <path
      fillRule='evenodd'
