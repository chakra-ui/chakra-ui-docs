export const SliderIllustration = () => (
  <svg
    width='400'
    height='300'
    viewBox='0 0 400 300'
  ...
  >
    ...
    <path
      fillRule='evenodd'
      clipRule='evenodd'
      d='M53 150C53 147.791 54.7909 146 57 146L273 146C275.209 146 277 147.791 277 150C277 152.209 275.209 154 273 154L57 154C54.7909 154 53 152.209 53 150Z'
      fill='#38B2AC'
    />
    <g filter='url(#filter0_d_72_445)'>
      <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result='effect1_dropShadow_72_445'
        />
        <feBlend
          mode='normal'
          in='SourceGraphic'
          in2='effect1_dropShadow_72_445'
          result='shape'
        />
      </filter>
    </defs>
