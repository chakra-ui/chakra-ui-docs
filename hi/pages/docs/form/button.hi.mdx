...
<ComponentLinks theme={{ componentName: "button" }} github={{ package: npm ={{ "@chakra-ui>
...
You can also use icons from popular libraries like [react-icons](https://react-icons.github.io/react-icons/) and pass it into the button.
...
The Facebook and Twitter icons in the above example are available from [`react-icons`](https://react-icons.netlify.com/#/) as `FaFacebook` and `FaTwitter`, found in the `react-icons/fa` import.
