...
<ComponentLinks theme={{ componentName: "modal" }} github={{ package: npm ={{ "@chakra-ui>
...
> If the content within the modal overflows beyond the viewport, don't use this prop. Try setting the [overflow behavior](#modal-overflow-behavior) instead.
